...
from clicomp.config.schema import ExecToolConfig
from clicomp.providers.base import LLMProvider
from clicomp.utils.helpers import build_assistant_message
...
class SubagentManager:
    ...
    async def spawn(
        ...
        origin = {"channel": origin_channel, "chat_id": origin_chat_id, "session_key": session_key or f"{origin_channel}:{origin_chat_id}"}
