...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install clicomp-ai[matrix]"
    ) from e
...
from clicomp.config.paths import get_data_dir, get_media_dir
from clicomp.config.schema import Base
from clicomp.utils.helpers import safe_filename
