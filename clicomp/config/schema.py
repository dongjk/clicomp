...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.clicomp/workspace"
...
class Config(BaseSettings):
    """Root configuration for clicomp."""
    ...
    def _match_provider(
        ...
        from clicomp.providers.registry import PROVIDERS, find_by_name
    ...
    model_config = ConfigDict(env_prefix="clicomp_", env_nested_delimiter="__")
